...
class Product{
    ...
    {
        return round($this->price * 1.2, 2); // Ajout de 20% par exemple
    }
...
/*  Q2
    ...
    -> Déjà fait : la propriété $price est 'protected'
*/
...
class Amiibo extends Product
{
    ...
    public function __construct(string $name, string $compatibility, string $description = "")
    {
...
// Création des objets et ajout au tableau unique $products
