...
abstract class Product {
    ...
    {
        $template = file_get_contents("./templates/template-card-".get_class($this).".html.inc");
...
class Tshirt extends Product
{
    ...
    public function render(): string
    {
        $template = parent::render();
        $search = ["{{sizes}}"];
        $replace = [implode(" - ", $this->getSizes()), $this->getPrice()];
        return str_replace( $search, $replace, $template);   
    }
}
...
/*
en déplaçant la méthode getPrice dans Product et en surchargeant 
cette méthode dans Amiibo, vous avez démontré le principe du polymorphisme, 
permettant aux classes dérivées de personnaliser le comportement hérité de la classe parent
*/